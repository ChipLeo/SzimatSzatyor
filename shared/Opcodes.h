...
// CMSGs 6.0.3.19342
enum OpcodeClient : unsigned int
{
    ...
    CMSG_GET_UNDELETE_COOLDOWN_STATUS                 = 0xBADD,
    CMSG_GHOST                                        = 0xBADD,
    ...
    CMSG_ROUTER_CLIENT_LOG_STREAMING_ERROR            = 0xBADD,
...
// SMSGs 6.0.3.19342
enum OpcodeServer : unsigned int
{
    ...
    SMSG_CREATURE_QUERY_RESPONSE                      = 0xBADD,
    ...
    SMSG_EQUIPMENT_SET_LIST                           = 0xBADD,
    ...
    SMSG_FEATURE_SYSTEM_STATUS_GLUE_SCREEN            = 0xBADD,
    ...
    SMSG_LOGIN_SETTIMESPEED                           = 0xBADD,
...
struct OpcodeHandler
{
    ...
    OpcodeHandler(unsigned int opcodeNumber, char const* _name)
...
private:
    void ValidateAndSetOpcode(unsigned int opcodeNumber, char const* name);
